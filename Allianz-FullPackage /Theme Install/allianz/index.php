...
get_header();
	...
	allianz_content_has_sidebar_open('sidebar-post');
	...
	if ( have_posts() ) {
		...
		allianz_posts_pagination();
	} else {
		get_template_part( 'template-parts/content', 'none' );
	}

	allianz_content_has_sidebar_close('sidebar-post');

	if(allianz_show_sidebar('sidebar-post')){ 
