...
<header id="cms-header-wrap" class="site-header">
    <div id="cms-header" class="<?php echo allianz_header_classes(); ?>">
        ...
        <div class="<?php echo allianz_header_container_classes('d-flex gap-40 gap-tablet-10 justify-content-between'); ?>">
            <?php 
            // logo
            ...
            get_template_part('template-parts/header/header-menu', '',[
                'before' => '<nav class="site-navigation site-navigation-dropdown">', 
                'after'  => '</nav>',
                'menu'   => allianz_get_opts('dropdown_menu', '', 'header_custom'),
                'custom_menu_class' => 'cms-menu-line-title',
            ]);
            ?>
            <div class="<?php echo allianz_header_tools_classes(['class' => 'site-tools flex-auto d-flex gap-30 gap-tablet-extra-20 gap-tablet-10 justify-content-end align-items-center']); ?>">
                <?php
                    // Search icon
