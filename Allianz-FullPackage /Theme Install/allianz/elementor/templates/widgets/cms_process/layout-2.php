...
<div <?php etc_print_html($widget->get_render_attribute_string('wrap')); ?>>
	<div class="cms-process-left flex-auto pt-110 pt-tablet-40">
		<div class="cms-eheading-wrap">
			<?php 
				// Heading icon
		...
		<div class="cms-hidden-tablet-extra">
			<?php 
					// Process Item
		...
		<div class="cms-swiper-vertical swiper cms-hidden-max-tablet">
	...
	<div class="cms-process-right flex-basic pl-130 pl-laptop-40 cms-hidden-max-tablet align-self-end">
