...
<div <?php etc_print_html($widget->get_render_attribute_string('wrap')); ?>>
	<div class="d-flex gutter">
		...
		<div class="cms-scrolling cms-sticky-enable col-6 col-mobile-extra-12 pl-90 pl-laptop-20">
			<div class="process--sdesc cms-sticky cms-sticky-bottom cms-remove-next-sticky pb-195 pb-mobile-50 pt-320">
			...
			?>
				<div class="cms-sticky-item cms-sticky cms-sticky-bottom cms-scrolling-item cms-scrolling-item-<?php echo esc_attr($count);?> cms-hover-show-icon-zoomin cms-transition">
					<div class="cms-sticky-zoom-in bg-white cms-radius-8 p-50 p-lr-tablet-30 pl-mobile-20 cms-transition">
						<div class="process-title d-flex gap-30 bdr-b-1">
							...
							<div class="process--title text-22 lh-12727 font-600 text-primary flex-basic mt-n3 pb-30"><?php etc_print_html($_process['title']); ?></div>
						</div>
						<div class="process-banner-icon text-center d-flex justify-content-center"><?php
							// Icon/ Image
							ob_start();
						...
						?></div>
						<div class="process-desc text-15 pt-30"><?php etc_print_html($_process['desc']); ?></div>
					</div>
				</div>
			<?php } ?>
		</div>
