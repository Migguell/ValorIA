...
$settings['readmore_text'] = !empty($settings['readmore_text']) ? $settings['readmore_text'] : esc_html__('Explore More','allianz');
...
$posts_data = array(
    ...
    'item_class'                 => 'cms-swiper-item swiper-slide hover-image-zoom-in hover-show-excerpt'
);
// Wrap attributes
...
<div <?php etc_print_html($widget->get_render_attribute_string('wrap')); ?>>
    <?php if(!empty($settings['smallheading_text']) || !empty($settings['heading_text']) || $arrows == 'yes') { ?>
        <div class="d-flex gap-40 align-items-center justify-content-between mb-50">
            <div <?php etc_print_html($widget->get_render_attribute_string('heading-wrap')); ?>>
                <div <?php etc_print_html( $widget->get_render_attribute_string( 'smallheading_text' ) ); ?>><?php 
                    echo etc_print_html( $settings['smallheading_text'] ); 
                ?></div>
                <h2 <?php etc_print_html( $widget->get_render_attribute_string( 'heading_text' ) ); ?>><?php 
                    echo etc_print_html( $settings['heading_text'] ); 
                ?></h2>
            </div>
            <?php if ($arrows == 'yes') : ?>
    ...
    <div class="cms-carousel swiper">
        <div <?php allianz_elementor_swipper_wrapper_classes_render($widget, $settings); ?>>
            <?php
