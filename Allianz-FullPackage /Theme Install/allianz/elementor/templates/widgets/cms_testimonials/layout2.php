...
<div <?php etc_print_html($widget->get_render_attribute_string('wrap')); ?>>
    <span class="absolute top-right text-130 text-grey allianz-icon-quote mt-n40"></span>
    ...
    ?>
        ...
        <div class="cms-carousel-nav-dots d-flex flex-nowrap gap-40 align-items-center pt-35">
            <?php // Arrows
            if ($arrows == 'yes') : ?>
