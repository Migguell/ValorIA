...
<div <?php etc_print_html($widget->get_render_attribute_string('wrap')); ?>>
    <div class="d-flex flex-nowrap flex-tablet-wrap gutter align-items-end justify-content-between pb-50 empty-none"><?php
        ...
        <?php endif;
        if(!empty($settings['btn_text']) || $arrows == 'yes' ):  ?>
        <div class="flex-auto col-mobile-extra-12 d-flex gap-60 gap-laptop-40 gap-tablet-30 align-items-center justify-content-between"><?php 
