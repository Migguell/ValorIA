...
<div <?php etc_print_html($widget->get_render_attribute_string('wrap')); ?>>
    <?php if(!empty($settings['smallheading_text']) || !empty($settings['heading_text'])) : ?>
    ...
    <?php endif;
        // Arrow
        if ($arrows == 'yes') : ?>
            <div class="cms-carousel-buttons d-flex justify-content-end justify-content-mobile-extra-center gap-30 pt-45">
