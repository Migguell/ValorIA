...
// Main Post Query
$main_posts = etc_get_posts_of_grid('cms-career', [
...
// Second Post Query
$second_posts = etc_get_posts_of_grid('cms-career', 
    [
        'post_type' => 'cms-career',   
        'source'    => $source,
        'orderby'   => $orderby,
        ...
        <div class="cms-sticky">
            ...
            foreach ($main_posts['posts'] as $post):
                allianz_elementor_post_thumbnail_render($settings, [
                    'post_id'       => $post->ID,
                    'custom_size'   => ['width' => 600, 'height' => 400],
                    'img_class'     => 'img-cover',
                    'as_background' => false,
                    'max_height'    => true,
            ...
            ?>
                <div class="cms--content bg-white pt-25 pl-40 pl-smobile-20">
                    <div class="cms-post-meta d-flex gap-10 align-items-center text-13"><?php 
                        allianz_the_terms($post->ID, 'career-category', '<span class="separator small"></span>', 'text-primary text-hover-primary cms-hover-underline');
                    ?></div>
                    ...
                    <div class="post-excerpt text-line-4 pt-15 mb-30 empty-none text-15"><?php the_excerpt(); ?></div>
                    <div class="post-date text-meta text-14 pt-17"><?php echo get_the_date('', $post->ID); ?></div>
                </div>
            <?php endforeach; ?>
        </div>
    </div>
        ...
        ?>
                <div class="cms-content d-flex gap-40 gap-tablet-10 gap-mobile-extra-40 gap-smobile-10 align-items-center hover-image-zoom-out pl-40 pl-mobile-extra-20">
                    ...
                    <div class="flex-basic flex-tablet-full flex-mobile-extra-basic flex-smobile-full">
                        ...
                        <div class="post-date text-14 pt-10"><?php echo get_the_date('', $post->ID); ?></div>
                    </div>
                </div>
        <?php endforeach; ?>
    </div>
