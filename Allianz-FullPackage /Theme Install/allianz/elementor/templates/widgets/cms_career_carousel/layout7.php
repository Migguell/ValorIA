...
extract(etc_get_posts_of_grid( 'cms-career', [
    'source'   => $source,
    'orderby'  => $orderby,
    'order'    => $order,
    'limit'    => $limit
...
$thumbnail_custom_dimension = [
    'width'  => !empty($settings['thumbnail_custom_dimension']['width']) ? $settings['thumbnail_custom_dimension']['width'] : 486,
    'height' => !empty($settings['thumbnail_custom_dimension']['height']) ? $settings['thumbnail_custom_dimension']['height']: 324
];
...
<div <?php etc_print_html($widget->get_render_attribute_string('wrap')); ?>>
    <div class="d-flex flex-nowrap flex-tablet-wrap gutter align-items-end justify-content-between pb-50">
        ...
        <div class="flex-auto col-mobile-extra-12 d-flex gap-60 gap-laptop-40 gap-tablet-30 align-items-center justify-content-between">
