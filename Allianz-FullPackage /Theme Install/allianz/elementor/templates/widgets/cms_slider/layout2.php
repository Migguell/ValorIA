...
// Description
$cms_slider_desc_wrap_classes = [
    'cms-slider-desc-wrap empty-none',
    allianz_add_hidden_device_controls_render($settings, 'desc_'),
    'text-17',
    'd-flex gap-10 justify-content-between',
    'pt-75 pt-tablet-20'
];
            ...
            <div class="cms-slider-item swiper-slide relative cms-hover-icon-alternate">
                ...
                <?php 
                    ...
                    $widget->add_render_attribute($title_key, [
                        'class' => [
                            'cms-slider-title heading text-white mt-n10 empty-none text-65 text-tablet-40 text-mobile-30',
                    ...
                    $widget->add_render_attribute($primary_btn_key, [
                        'class' => [
                            'cms-slider-btn',
                            'cms-hover-icon-alternate rtl-flip text-50 text-tablet-40 text-mobile-30',
                ...
                <div class="cms-slider-content cms-overlay d-flex align-items-center">
                    <div <?php etc_print_html($widget->get_render_attribute_string('container')); ?>>
                        ...
                        <div class="<?php echo allianz_nice_class($cms_slider_desc_wrap_classes); ?>">
                            <a class="cms-scroll-down text-white text-hover-white order-mobile-last" href="#next-section">
                                <div class="cms-rotate-90">
                                    <div class="cms-scroll--right allianz-icon-right-arrow"></div>
                                </div>
                            </a>
