...
<div <?php etc_print_html($widget->get_render_attribute_string('wrap')) ?>>
    <div class="swiper-wrapper">
        <?php foreach ($cms_slides as $key => $cms_slide) { ?>
            <div class="cms-slider-item swiper-slide relative cms-hover-icon-alternate">
                ...
                <?php 
                    ...
                    switch($cms_slide['slide_type']){
                        case 'video':
                            // video
                            allianz_elementor_video_render($widget, $settings, ['url' => $cms_slide['video_url']]);
                            break;
                        case 'img':
                            // image
                    ...
                    $widget->add_render_attribute($desc_key_text, [
                        'class' => 'cms-slider--desc text-line-5 empty-none'
                    ]);
                    // Primary Button
                    ...
                    $widget->add_render_attribute($primary_btn_key, [
                        'class' => [
                            'cms-slider-btn',
                            'btn btn-lg btn-accent text-white btn-hover-accent text-hover-white cms-hover-move-icon-up',
                    ...
                    $widget->add_render_attribute($secondary_btn_key, [
                        'class' => [
                            'cms-slider-btn',
                            'btn btn-lg btn-white text-primary btn-hover-accent text-hover-white cms-hover-move-icon-up',
                ...
                <div class="cms-slider-content cms-overlay d-flex align-items-center">
                    <div <?php etc_print_html($widget->get_render_attribute_string('container')); ?>>
                        <div class="cms-slider--content">
                            ...
                            <div class="d-flex flex-nowrap gap-40 gap-tablet-30 gap-mobile-20 pt-25">
                                <?php 
                                    // icon
                                    allianz_elementor_icon_image_render($widget, $settings, [
                                        ...
                                        'img_size'    => false,
                                        'class'       => 'flex-auto',
                                        'before'      => '<div data-cms-animation="button_primary_animation" data-cms-animation-delay="button_primary_animation_delay">',
                                        'after'       => '</div>' 
                                    ]);
                                ?>
                                <div class="flex-basic">
                                    <?php if(!empty($cms_slide['description_title']) || !empty($cms_slide['description'])): ?>
                                    <div <?php etc_print_html($widget->get_render_attribute_string($desc_key)); ?>>
                                        <div <?php etc_print_html($widget->get_render_attribute_string($desc_title_key)); ?>><?php 
                                    ...
                                    ?>
                                        <a <?php etc_print_html($widget->get_render_attribute_string($primary_btn_key)); ?>><?php 
                                            // text 
                                    ...
                                    <?php endif; 
                                        ...
                                        allianz_elementor_button_video_render($widget, $cms_slide, [
                                            ...
                                            'text'       => '',
                                            'layout'     => '1',
                                            'class'      => 'relative '.allianz_add_hidden_device_controls_render($settings, 'btn_video_'),
    ...
    <?php if ($arrows == 'yes') : ?>
    <div class="flex-auto d-flex gap-30 align-items-center absolute bottom-right mb-50 mr-50 mb-tablet-30 mr-tablet-30">
