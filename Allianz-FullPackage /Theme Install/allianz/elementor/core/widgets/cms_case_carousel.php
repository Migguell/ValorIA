...
if (!function_exists('allianz_widget_cms_case_carousel_register_controls')) {
    add_action('etc_widget_cms_case_carousel_register_controls', 'allianz_widget_cms_case_carousel_register_controls', 10, 1);
    function allianz_widget_cms_case_carousel_register_controls($widget)
    {
        // Layout Settings
        ...
        $widget->start_controls_section(
            'heading_section',
            [
                'label' => esc_html__('Element Heading Settings', 'allianz'),
                'tab'   => Controls_Manager::TAB_CONTENT,
            ]
        );
            $widget->add_control(
