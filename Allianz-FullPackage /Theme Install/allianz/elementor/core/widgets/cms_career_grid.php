...
if (!function_exists('allianz_widget_cms_career_grid_register_controls')) {
    add_action('etc_widget_cms_career_grid_register_controls', 'allianz_widget_cms_career_grid_register_controls', 10, 1);
    function allianz_widget_cms_career_grid_register_controls($widget)
    {
        // Layout Settings
        ...
        $post_term_options = etc_get_grid_term_options('cms-career', ['career-category']);
        $widget->start_controls_section(
            'source_section',
            [
