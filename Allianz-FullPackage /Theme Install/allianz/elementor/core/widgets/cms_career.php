...
if (!function_exists('allianz_widget_cms_career_register_controls')) {
    add_action('etc_widget_cms_career_register_controls', 'allianz_widget_cms_career_register_controls', 10, 1);
    function allianz_widget_cms_career_register_controls($widget)
    {
        // Layout Settings
