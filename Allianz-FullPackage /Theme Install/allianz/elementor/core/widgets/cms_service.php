...
if (!function_exists('allianz_widget_cms_service_register_controls')) {
    add_action('etc_widget_cms_service_register_controls', 'allianz_widget_cms_service_register_controls', 10, 1);
    function allianz_widget_cms_service_register_controls($widget)
    {
        // Layout Settings
                ...
                [
                    ...
                    'options' => [
                        '1' => [
                            ...
                            'image' => get_template_directory_uri() . '/elementor/templates/widgets/cms_service/layout/1.webp'
                        ],
                        '2' => [
                            'label' => esc_html__( 'Layout 2', 'allianz' ),
                            'image' => get_template_directory_uri() . '/elementor/templates/widgets/cms_service/layout/2.webp'
                        ]
                    ]
                ]
            );
