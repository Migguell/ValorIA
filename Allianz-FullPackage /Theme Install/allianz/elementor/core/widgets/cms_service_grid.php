...
if (!function_exists('allianz_widget_cms_service_grid_register_controls')) {
    add_action('etc_widget_cms_service_grid_register_controls', 'allianz_widget_cms_service_grid_register_controls', 10, 1);
    function allianz_widget_cms_service_grid_register_controls($widget)
    {
        // Layout Settings
        ...
        $widget->start_controls_section(
            ...
            $widget->add_control(
                ...
                [
                    ...
                    'type'        => Controls_Manager::TEXTAREA,
                    'default'     => 'No matter what area or challenge you’re tackling, we can help. Our firm identify the most relevant insights and apply integrated technologies with innovative ways to empower our people.',
                    'placeholder' => esc_html__( 'Enter your text', 'allianz' ),
                    'rows'        => 10,
                    'show_label'  => true,
                    'condition' => [
        ...
        $widget->start_controls_section(
            ...
            allianz_elementor_filter_settings($widget);
            $widget->add_control(
                'pagination_type',
                [
                    'label'   => esc_html__('Pagination Type', 'allianz'),
                    'type'    => Controls_Manager::SELECT,
                    'options' => [
                        'pagination' => esc_html__('Pagination', 'allianz'),
                        'loadmore'   => esc_html__('Loadmore', 'allianz'),
