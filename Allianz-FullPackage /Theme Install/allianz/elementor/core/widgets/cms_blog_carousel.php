...
if (!function_exists('allianz_widget_cms_blog_carousel_register_controls')) {
    add_action('etc_widget_cms_blog_carousel_register_controls', 'allianz_widget_cms_blog_carousel_register_controls', 10, 1);
    function allianz_widget_cms_blog_carousel_register_controls($widget)
    {
        // Layout Settings
                ...
                [
                    ...
                    'options' => [
                        ...
                        '11' => [
                            ...
                            'image' => get_template_directory_uri() . '/elementor/templates/layout/11.webp'
                        ]
                    ]
                ]
            );
        ...
        $widget->start_controls_section(
            ...
            allianz_elementor_colors_opts($widget,[
                ...
                'label'    => esc_html__( 'Color', 'allianz' ),
                'selector' => [
                    '{{WRAPPER}} .cms-heading, {{WRAPPER}} .cms-heading' => 'color: {{VALUE}};',
                ],
                'condition' => [
                    'heading_text!' => ''
                ]
